                        ...
                        <div class="row custom-tab">
                            ...
                            <div class="col-lg-3 col-md-12">
                                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <button class="nav-link" id="v-pills-3-tab" data-bs-toggle="pill" data-bs-target="#v-pills-3" type="button" role="tab" aria-controls="v-pills-3" aria-selected="false">Why Choose </button>
                                    <button class="nav-link" id="v-pills-4-tab" data-bs-toggle="pill" data-bs-target="#v-pills-4" type="button" role="tab" aria-controls="v-pills-4" aria-selected="false">Feature Job </button>
                                    <button class="nav-link" id="v-pills-5-tab" data-bs-toggle="pill" data-bs-target="#v-pills-5" type="button" role="tab" aria-controls="v-pills-5" aria-selected="false">Why Choose </button>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <textarea name="text" class="form-control" cols="30" rows="10">{{ $page_home_data->text }}</textarea>
                                                </div>
                                                <div class="row">
                                    ...
                                    <div class="tab-pane fade" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-4-tab" tabindex="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-4">
                                                    <label class="form-label">Heading *</label>
                                                    <input type="text" class="form-control" name="feature_job_heading" value="{{ $page_home_data->feature_job_heading }}">
                                                </div>
                                                <div class="mb-4">
                                                    <label class="form-label">Sub Heading</label>
                                                    <input type="text" class="form-control" name="feature_job_subheading" value="{{ $page_home_data->feature_job_subheading }}">
                                                </div>
                                                <div class="mb-4">
                                                    <label class="form-label">Status *</label>
                                                    <select name="feature_job_status" class="form-control select2">
                                                        <option value="Show" @if ($page_home_data->feature_job_status == 'Show') selected @endif>Show</option>
                                                        <option value="Hide"@if ($page_home_data->feature_job_status == 'Hide') selected @endif>Hide</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
