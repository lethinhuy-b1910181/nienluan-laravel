...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin_blog_page_update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="meta_description" value="{{ $page_blog_data->meta_description }}">
                        </div>
