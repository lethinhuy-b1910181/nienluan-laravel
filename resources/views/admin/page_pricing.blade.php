...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin_pricing_page_update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="meta_description" cols="30"class="form-control h_100" rows="10">{{ $page_pricing_data->meta_description }}</textarea>
                        </div>
