                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    src="{{ asset('uploads/company_default_logo.jpg')}}"
                                    alt=""
                                    class="logo"/>
                                    @else
                                        <img
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    <select name="company_location_id" id="" class="form-control select2">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    <select name="company_industry_id" id="" class="form-control select2">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    <select name="company_size_id" id="" class="form-control select2">
