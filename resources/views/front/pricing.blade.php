                        ...
                        <div class="card-body">
                            ...
                            <ul class="fa-ul">
                                <li>
                                    ...
                                    @endphp
                                    <span class="fa-li"><i class="{{ $icon_code }}" style="color: {{ $icon_color }}"></i></span>
                                     {{ $text }} Job Post Allowed
                                </li>
                                <li>
                                    @php
                                        if($item->total_allowed_feature_jobs  == -1){
                                            $text = "Unlimited";
                                            $icon_code = "fas fa-check";
                                            $icon_color = "green";
                                        }elseif($item->total_allowed_feature_jobs  == 0){
                                            $text = "No";
                                            $icon_code = "fas fa-times";
                                            $icon_color = "red";
                                        }else{
                                            $text = $item->total_allowed_feature_jobs;
                                            $icon_code = "fas fa-check";
                                            $icon_color = "green";
                                        }
                                    @endphp
