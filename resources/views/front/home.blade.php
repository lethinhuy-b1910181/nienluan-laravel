...
<div class="slider" style="background: url({{ asset('uploads/'.$home_page_data->background) }}) no-repeat top center; ">
    <div class="bg"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
    ...
    <div class="job">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="heading">
                        <h2>{{ $home_page_data->feature_job_heading }}</h2>
                        <p>{{ $home_page_data->feature_job_subheading }}</p>
                    </div>
                </div>
            </div>
            <div class="row">
